...
namespace Arcana
{
	...
	//instancing -------------
	void SphericalDeformation::setUniforms(Matrix4d world, Matrix4d projection, Matrix4d view, Vector3d eyePosition, TerrainNode* n, std::vector<Vector4f>& data, float r) const
	{
		Deformation::setUniforms(world, projection, view, eyePosition, n, data, r);
