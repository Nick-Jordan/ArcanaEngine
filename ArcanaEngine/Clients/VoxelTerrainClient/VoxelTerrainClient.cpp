// VoxelTerrainClient.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "VoxelTerrainClient.h"
	...
	_In_ int       nCmdShow)
{
	...
	appDefinition.setAppName("Voxel Terrain Client");
	appDefinition.setWindowClass(L"VOXEL_TERRAIN_CLIENT");
	...
	GEngine->getApplicationInstance()->getActiveWindow().setMouseCursorVisible(true);
