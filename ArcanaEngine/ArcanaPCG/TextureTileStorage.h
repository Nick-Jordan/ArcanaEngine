...
namespace Arcana
{
	struct ARCANA_PCG_API TextureUpdate
	{
		int32 x;
		int32 y;
		int32 layer;
	...
	class ARCANA_PCG_API TextureUpdater
	{
	public:
	...
	class ARCANA_PCG_API TextureTileStorage : public TileStorage
	{
	public:

		class ARCANA_PCG_API TextureSlot : public Slot
		{
		public:
